  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row items-center bg-neutral-800 rounded-xl shadow-lg p-6 mb-10">
      ...
      <div class="w-full md:w-1/4 flex justify-center md:justify-end mt-4 md:mt-0">
        <a href="file/Synthese_Stage_EPSM.pdf" target="_blank" class="bg-white text-black px-4 py-2 rounded font-semibold hover:bg-neutral-300 transition">
          Synthèse PDF
        </a>
      </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row items-center bg-neutral-800 rounded-xl shadow-lg p-6">
      ...
      <!-- Lien PDF à droite -->
      <div class="w-full md:w-1/4 flex justify-center md:justify-end mt-4 md:mt-0">
        <a href="file/Synthese_Stage_Chaptal.pdf" target="_blank" class="bg-white text-black px-4 py-2 rounded font-semibold hover:bg-neutral-300 transition">
          Synthèse PDF
        </a>
      </div>
    </div>
